...
_this.ChosenIndex=_this.SelIndex;
_this.Clear(); 
} 
...
_this.ReData.push(_this.Data[i]); _this.ReIds.push(_this.Ids[i]);
...
_this.TgList.style.cssText='display:block;z-index:551;position:absolute;background:#fff;border:#090 solid 1px;margin:-1px 0 0;padding: 5px;list-style:none;font-size:12px;'; 
_this.TgList.style.top='50px'; 
_this.TgList.style.left='0px'; 
...
GetSelectedId:function(){
	return this.ReIds[this.ChosenIndex];
}
} 
